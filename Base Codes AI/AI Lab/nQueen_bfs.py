...
class QueenSolver:
    ...
    def setup(self, queenNumber):
        ...
        if queenNumber < 4:
            print
            "ERROR: A solution is not available for this few number of queens"
            self.canRun = False
        elif queenNumber > 13:
            print
            "ERROR: This solution would take too long to calculate, and your computer would probably run out of memory first!"
            self.canRun = False
    ...
    def finish(self, table, col):
        ...
        if col == self.tableSize:
            ...
            ""
            print
            "Total of", self.tableSize, "Queens placed!"
            print
            "Solution:"
            self.display(table)
        else:
            ...
            ""
            print
            "ERROR: Could not place all queens for some unknown reason =["
...
def ask():
    while True:
        ...
        ""
        print
        "How many Queens would you like use?  [8]"
        input = raw_input()
...
def prompt():
    ...
    while True:
        ...
        ""
        print
        "Would you like to run the script again? Please enter Y/N  [N]"
        input = raw_input()
